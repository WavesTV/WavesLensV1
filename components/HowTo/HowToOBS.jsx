...
export function HowToOBS() {
    ...
    return(
      ...
      <Space h="xs" />
        ...
        <Space h="xs" />
        <Image alt="OBS Tutorial Create Source step 1" src="https://mintlify.s3-us-west-1.amazonaws.com/na-36/images/obs/OBS1.png" />
        <Space h="xs" />
        <Center>
        <Image alt="OBS Tutorial Create Source step 2" src="https://mintlify.s3-us-west-1.amazonaws.com/na-36/images/obs/OBS2.png" />
        </Center>
        <Space h="xs" />
        <Image alt="OBS Tutorial Create Source step 3" src="https://mintlify.s3-us-west-1.amazonaws.com/na-36/images/obs/OBS3.png" />
        <Space h="xs" />
        ...
        <Space h="xs" />
        <Image alt="OBS Tutorial Update OBS Settings step 1" src="https://mintlify.s3-us-west-1.amazonaws.com/na-36/images/obs/OBS4.png" />
        <Space h="xs" />
        <Image alt="OBS Tutorial OBS Settings step 2" src="https://mintlify.s3-us-west-1.amazonaws.com/na-36/images/obs/OBS3.png" />
        <Space h="xs" />
